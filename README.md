...
FinanceApp │ ├── Controllers │ └── ExpensesController.cs │ ├── Models │
└── Expense.cs │ ├── Data │ ├── FinanceAppContext.cs │ └── Service │ ├──
iExpensesService.cs │ └── ExpensesService.cs │ ├── Views │ └── Expenses
│ ├── Index.cshtml │ └── Create.cshtml │ ├── appsettings.json └──
Program.cs
